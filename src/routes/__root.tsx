...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Your Name — Aspiring Software Developer | B.Tech CSE Portfolio" },
      { name: "description", content: "Portfolio of an aspiring software developer and B.Tech CSE student — projects, skills, experience, and contact." },
      { name: "author", content: "Your Name" },
      { property: "og:title", content: "Your Name — Aspiring Software Developer" },
      { property: "og:description", content: "Portfolio of an aspiring software developer and B.Tech CSE student." },
